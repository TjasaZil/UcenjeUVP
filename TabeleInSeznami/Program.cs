namespace TabeleInSeznami
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            /* Naloga 5.0.0.3. Napisite program, ki bo v danem celostevilskem seznamu preveril ali obstaja stevilo, ki ga vnese uporabnik. Program naj izpise vse pozicije tega elementa, ce le ta obstaja v seznamu, sicer naj izpiˇse, da elementa ni mogoce najti. */
